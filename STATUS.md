...
- ✅ Four brands seeded, all editable in the app: **CARES Works** (neon blue + green, `/cares-works-neon-logo.png`, prefix `CW-`), **CARES Consulting** (neon blue with green/pink/orange flares per Kari 9/8 — no longer the slate/orange Maddie palette, `CC-`), **K Co LLC** (`KC-`, pink `#e0218a`, checks payable to K Co LLC — her call 9/8, renamed from "Kari Kounkel"), **Court of Accounts** (`COA-`, presets carry the book cover as the header image).
