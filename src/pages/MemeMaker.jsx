...
const THEMES = [
  ...
  { key: "valentines", name: "Valentine's Day", src: "/themes/valentines.png", box: [87, 243, 906, 906] },
  { key: "easter", name: "Easter", src: "/themes/easter.png", box: [87, 243, 906, 906] },
  { key: "spring", name: "Spring", src: "/themes/spring.png", box: [87, 243, 906, 906] },
  { key: "graduation", name: "Graduation", src: "/themes/graduation.png", box: [87, 243, 906, 906] },
  { key: "fathers", name: "Father's Day", src: "/themes/fathers.png", box: [87, 243, 906, 906] },
  { key: "halloween", name: "Halloween", src: "/themes/halloween.png", box: [87, 243, 906, 906] },
  { key: "newyear", name: "New Year", src: "/themes/newyear.png", box: [87, 243, 906, 906] },
  { key: "winter", name: "Winter", src: "/themes/winter.png", box: [87, 243, 906, 906] },
...
const THEME_STYLES = {
  america250: CARD, july4: CARD, memorial: CARD,
  newyear:    { navy: "#2E2E38", red: "#9A7B2E", gold: "#C2A14B", cream: "#F0E9D6", parch: "#F5F1E6", ink: "#33333A", sideFill: "#ECE4CE" },
  valentines: { navy: "#9E2B3A", red: "#C45B6B", gold: "#C98A92", cream: "#F7E3E2", parch: "#FBF1F0", ink: "#5A3A40", sideFill: "#F3DADE" },
  spring:     { navy: "#5A7A45", red: "#C98AA0", gold: "#C0A24E", cream: "#EEF0DE", parch: "#F5F3E7", ink: "#3E4632", sideFill: "#E6EAD2" },
  winter:     { navy: "#3A5A6E", red: "#7FA0B0", gold: "#9FB4C0", cream: "#EAF0F2", parch: "#F3F6F7", ink: "#33424A", sideFill: "#DDE7EC" },
  halloween:  { navy: "#5A3A22", red: "#C86A2A", gold: "#B0883C", cream: "#EFE3CC", parch: "#F2EAD6", ink: "#3A2E22", sideFill: "#E9D9BC" },
  graduation: { navy: "#1F3A5F", red: "#8A6D2E", gold: "#B89441", cream: "#EFE9D8", parch: "#F4F1E6", ink: "#2E2E33", sideFill: "#ECE4CE" },
  fathers:    { navy: "#2E4257", red: "#7A5A3E", gold: "#9A7B4A", cream: "#EDE7D8", parch: "#F1ECE0", ink: "#33342E", sideFill: "#E4DCC8" },
  easter:     { navy: "#8A6FA0", red: "#D08AA0", gold: "#C2A24E", cream: "#F0EAEE", parch: "#F7F3EC", ink: "#4E4658", sideFill: "#EAE2EC" },
