...
const S = {
  ...
  ink: "#0a0a14", rule: "#e2e8f0", muted: "#64748b", gold: "#22c55e",
          ...
          <div style={{ marginTop: 48, background: S.slate, borderRadius: 14, padding: "36px 40px", color: "#fff", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
                ...
                <a href="https://buy.stripe.com/14A5kD4B981AgTxcuM18c09" style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: S.gold, textDecoration: "none", letterSpacing: "0.08em", fontWeight: 700 }}>Or annual — $270/year (2 months free)</a>
              </div>
            </div>
          </div>
        )}
